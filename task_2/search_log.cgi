...
sub define
{
  ...
  # OUT: исходное значение или пустая строка, если исх. значение не определено
...
sub get_records_count
{
  ...
  # OUT: записи, удовлетворяющие критерию поиска - ссылка на массив хэшей [{created, str}]
...
sub format_records
{
  ...
  # OUT: строка - форматированные и объединенные записи (HTML таблица), или пустая строка
